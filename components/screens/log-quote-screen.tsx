...
import { Calendar, CalendarIcon, Plus, X, Target, ArrowLeft, ArrowRight, ChevronRight, ChevronLeft, CheckCircle, Lightbulb, HelpCircle, Info, ChevronDown, ChevronUp } from "lucide-react"
...
const guideSteps: GuideStep[] = [
  ...
  },
  {
    ...
    description: "Select the type of work this quote is for. This helps categorize your quotes and makes them easier to manage.",
  ...
  },
  {
    ...
    action: "highlight",
    requiresInput: true,
    inputField: "quoteReferenceNumber",
  },
  {
    id: "source-enquiry",
...
export function LogQuoteScreen({ 
  ...
  const startGuide = () => {
    ...
    // Pre-fill fields with sample data for smooth guided tour
    setCustomer("Sample Customer 1")
    setSite("Main Office")
    setJobType("electrical")
    setDescription("Installation and maintenance of electrical systems")
    setQuoteReferenceNumber("QUO-2024-001")
    setSourceOfEnquiry("website")
  }
  ...
  // - showGuide=true: Simplified version (from completion screen tasks)
  // - showGuide=false/undefined: BAU version (from normal navigation)
  const isSimplifiedVersion = showGuide

  // SIMPLIFIED VERSION: For completion screen tasks
  // Shows main fields together with additional information in collapsible section
        ...
        <div className="p-6">
          <div className="mb-6" ref={pageHeaderRef}>
            <div className="flex items-center justify-between">
              <div>
                <h1 className="text-2xl font-bold text-gray-900 mb-2">Create Your First Quote</h1>
                <p className="text-gray-600">Complete the essential fields below to create your quote. You can add more details later.</p>
                {isGuideActive && (
          ...
          <Card className="mb-6">
            ...
            <CardContent className="space-y-6">
              ...
              {/* Quote Reference & Source Row */}
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2" ref={quoteReferenceInputRef}>
                  <Label className="flex items-center gap-2">
                    Quote Reference <span className="text-red-500">*</span>
                    <HelpCircle className="w-4 h-4 text-gray-400" />
                  </Label>
                  <Input
                ...
                <div className="space-y-2" ref={sourceEnquirySelectRef}>
                  <Label className="flex items-center gap-2">
              ...
              <CollapsibleTrigger asChild>
                <CardHeader className="cursor-pointer hover:bg-gray-50 transition-colors">
                  ...
                  <p className="text-sm text-gray-600 mt-2">
                    Add title, trade details, priority, references, and other optional quote information
                  </p>
                </CardHeader>
              </CollapsibleTrigger>
              <CollapsibleContent>
                <CardContent className="space-y-6 pt-0">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                      <Label>Quote Ref 2</Label>
                      <Input
                        value={quoteRef2}
                        onChange={(e) => setQuoteRef2(e.target.value)}
                        placeholder="Enter reference..."
                      />
                    </div>
                  </div>
                  ...
                  {/* Chance of Sale */}
                  <div className="space-y-2">
                    <Label>Chance of Sale: {chanceOfSale[0]}%</Label>
                    <Slider
                      value={chanceOfSale}
        ...
        <Dialog open={showCongratulations} onOpenChange={setShowCongratulations}>
          <DialogContent className="sm:max-w-md">
            <DialogHeader className="text-center">
              ...
              <DialogDescription className="text-lg">You just created your first quote!</DialogDescription>
            </DialogHeader>
  ...
  // Shows the full interface with all sections and fields
  return (
              ...
              <div className="mt-8">
                ...
                <div ref={quoteReferenceInputRef} className="mt-6 space-y-2">
                  <Label htmlFor="quoteRef" className="text-sm font-medium">
                    Quote Reference Number <span className="text-red-500">*</span>
                  </Label>
                  <Input
                    id="quoteRef"
                    value={quoteReferenceNumber}
