...
export function ReportsScreen({ showGuide = false, onNavigateBackToTutorials, onTaskCompleted }: ReportsScreenProps) {
  ...
  const endGuide = () => {
    ...
    // Navigate back to completion screen when guide finishes
                    ...
                    <TableRow 
                      ...
                      className={`border-b border-gray-200 hover:bg-gray-50 ${
                        ...
                        report.name === "Outstanding Jobs by Engineer" 
                          ? "ring-2 ring-teal-500 ring-opacity-75 bg-teal-50 shadow-lg relative z-10" 
                          : ""
                      }`}
                    >
                      ...
                      <TableCell className="text-center py-3 px-4">
                        <div className="flex items-center justify-center gap-2">
                          ...
                          <Checkbox
                            ...
                            className="w-4 h-4 rounded border-gray-400 data-[state=checked]:bg-teal-600 data-[state=checked]:text-white"
                          />
                          {report.hasLink && <Link className="w-4 h-4 text-teal-600" />}
                        </div>
                      </TableCell>
                      <TableCell className="text-center py-3 px-4">
                        <Eye
                          className={`w-4 h-4 mx-auto cursor-pointer hover:text-teal-800 ${
                            isGuideActive && 
                            currentStep?.id === "outstanding-jobs-report" && 
                            report.name === "Outstanding Jobs by Engineer"
                              ? "text-teal-800 animate-pulse ring-2 ring-teal-400 rounded-full p-1 bg-teal-100"
                              : "text-teal-600"
                          }`}
